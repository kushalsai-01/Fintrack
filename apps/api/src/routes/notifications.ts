...
// PATCH aliases for frontend compatibility
...
// Clear all notifications (frontend calls DELETE /notifications and DELETE /notifications/clear)
router.delete('/', notificationController.clearAllNotifications);
router.delete('/clear', notificationController.clearAllNotificationsAlias);
