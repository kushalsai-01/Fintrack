  ...
  try {
    ...
    for (let month = 5; month >= 0; month--) {
      ...
      const expenseData = [
        ...
        { category: 'Food & Dining', amount: 400 + Math.random() * 100, description: 'Weekly Groceries', day: 7 },
        { category: 'Food & Dining', amount: 300 + Math.random() * 100, description: 'Grocery Shopping', day: 14 },
        { category: 'Transportation', amount: 100, description: 'Gas', day: 10 },
        { category: 'Transportation', amount: 50, description: 'Parking', day: 15 },
        { category: 'Food & Dining', amount: 80 + Math.random() * 40, description: 'Restaurant', day: 8 },
        { category: 'Food & Dining', amount: 60 + Math.random() * 30, description: 'Lunch out', day: 18 },
        ...
        { category: 'Entertainment', amount: 15, description: 'Streaming Service', day: 3 },
        { category: 'Entertainment', amount: 10, description: 'Music Subscription', day: 3 },
      ];
