    ...
    html: `
      ...
      <body>
        <div class="container">
          ...
          <div class="footer">
            <p>This email was sent by FinTrack Pro</p>
          </div>
        </div>
      </body>
      </html>
...
export async function sendWelcomeEmail(email: string, name: string): Promise<boolean> {
  return sendEmail({
    to: email,
    subject: 'Welcome to FinTrack Pro!',
    html: `
      <!DOCTYPE html>
      <html>
      <head>
      ...
      <body>
        <div class="container">
          <h1>Welcome to FinTrack Pro, ${name}!</h1>
          <p>We're excited to have you on board. FinTrack Pro is your AI-powered personal finance companion.</p>
          <h2>Get Started</h2>
          <ul>
